...
const translations = {
    en: {
        ...
        'candago-5-contrib': 'Core development of the React Native mobile app — screens, navigation and API integration — plus integration of the TensorFlow breed-classification model.',
        'candago-6-contrib': 'Full front-end development of the admin dashboard with Next.js, TypeScript and Tailwind (JWT auth, dashboards and data visualization), plus the chatbot conversation flows in Python/FastAPI and the NLP intent routing.',
    ...
    pt: {
        ...
        'candago-5-contrib': 'Desenvolvimento do app mobile em React Native — telas, navegação e consumo da API — e integração do modelo de classificação de raças com TensorFlow.',
        'candago-6-contrib': 'Desenvolvimento completo do front-end do painel administrativo com Next.js, TypeScript e Tailwind (autenticação JWT, dashboards e visualização de dados), além dos fluxos de conversa do chatbot em Python/FastAPI e do roteamento de intenções com NLP.',
